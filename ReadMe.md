...
5. Скопируйте код из файла ETL.ipynb в ноутбук Spark и запустите вычисления для анализа данных. Видео работы отправил в личку в телеге, мой ник https://t.me/MaxMinakov.
